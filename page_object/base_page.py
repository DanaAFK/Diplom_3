...
class BasePage:
    ...
    def visibility_of_element(self, locator, timeout=30):
    ...
    def visibility_not_of_element(self, locator, timeout=30):
    ...
    def invisibility_check(self, locator) -> object:
        return WebDriverWait(self.driver, 30).until(EC.invisibility_of_element(locator))
